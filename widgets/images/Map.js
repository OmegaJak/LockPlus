(function () {
    ...
    var div = divMaker('div', 'Map', '', 'width:270px;height:160px;position:absolute;top:0;left:0;font-family:helvetica;z-index:3;', ''),
        mapImage = divMaker('div', '', 'mapImage', 'pointer-events:none;position: absolute;top:0px;left:0px;width: 256px;height: 246px;background-image: url("http://lockplus.us/creator/widgets/resources/map.png");background-size: 256px;background-position: 5px 35px;background-repeat: no-repeat;', ''),
        pinImage = divMaker('div', 'pin', '', 'pointer-events:none;position: absolute;width: 30px;height: 30px;background-image: url("http://lockplus.us/creator/widgets/resources/pin.png");background-size: cover;opacity: 0.9;', ''),
        locationI = divMaker('span', 'locationI', 'location', 'pointer-events:none;margin-left: 30px;color:white;font-size:10px;white-space: nowrap;', ''),
        coords,
        miniMap;
    ...
    document.getElementById('locationI').innerHTML = 'Test Location';
