(function () {
    ...
    style.type = 'text/css';
    css = '.bgcircle{fill:transparent;stroke:#444;stroke-width:5;}.svgClock{ -webkit-transform:translate(25px, 25px)scale(0.8);}.circle{fill: transparent;stroke: white;stroke-width: 10;stroke-dasharray: 534;stroke-linecap: square;-webkit-transition: stroke-dashoffset 0.5s;}';
