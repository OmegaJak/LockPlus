(function () {
    ...
    bottomInside.style.cssText = 'position:absolute;bottom:4px;left:6px;width:26px;height:1px;background-color:white;-webkit-transform:rotate(180deg);';
