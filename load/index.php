...
echo '<style>#load{position:absolute;z-index:999;right:25px;background-color:#54606e; border-radius:2px;padding:5px;color:white;}</style>';
echo '<div id="load" onclick="loadtheme()">Enter Theme Name</div>';
$dir    = '../php/themes';
